...
public interface ISupplierContextFacade
{
    ...
    Task<Supplier?> FetchSupplierById(int id);
    Task<IEnumerable<Supplier>> FetchAllSuppliers();
    Task UpdateSupplier(int id, string supplierName, string contactName, string contactEmail, string phone, string address);
